function totalTime = coastTimeMod(r0, v0,beta)
...
[phase1Time, phase1V] = modTof(r0,v0,phase1R,beta);
%[phase1V, phase1Fpa] = getFPA(r0,v0,phase1R, departFPA);

[phase2Time, phase2V] = modTof(phase1R,phase1V,phase2R,beta);
%[phase2V, ~] = getFPA(phase1R,phase1V,phase2R, phase1Fpa);

[phase3Time, phase3V] = modTof(phase2R,phase2V,phase3R,beta);
